...
public class ProjectValidator implements Validator{
	...
	public void validate(Object obj, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "name","error.not-specified-name","Required field");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "beginDate","error.not-specified-beginDate","Required field");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "endPrevisionnalDate","error.not-specified-endDate","Required field");
	

	
		
		Project act = (Project)obj;
