var rules = {
	...
	'input.datepicker': function(elt) {
		new Control.DatePicker(elt, { icon: 'img/calendar.png' });
	},
	'input.timepicker': function(elt) {
		new Control.DatePicker(elt, { icon: 'img/clock.png', datePicker: false, timePicker: true });
	},
	'input.datetimepicker': function(elt) {
		new Control.DatePicker(elt, { icon: 'img/calendar.png', timePicker: true, timePickerAdjacent: true, use24hrs: true });
	},
	'input.datetimepicker_es': function(elt) {
		new Control.DatePicker(elt, { icon: 'img/calendar.png', locale:'es_AR', timePicker: true });
	},
